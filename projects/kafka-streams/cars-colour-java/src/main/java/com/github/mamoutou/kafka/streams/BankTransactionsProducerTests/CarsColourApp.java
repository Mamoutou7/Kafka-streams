package com.github.mamoutou.kafka.streams.BankTransactionsProducerTests;
...
public class CarsColourApp {

    public static void main(String[] args) {
        Properties config = new Properties();
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "car-colour-java");
        config.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:2181");
        ...
        usersAndColours.to("car-keys-and-colours");

        Serde<String> stringSerde = Serdes.String();
        Serde<Long> longSerde = Serdes.Long();

        // step 2 - we read that topic as a KTable so that updates are read correctly
        KTable<String, String> carsAndColoursTable = builder.table("car-keys-and-colours");

        // step 3 - we count the occurences of colours
        KTable<String, Long> favouriteColours = carsAndColoursTable
        ...
        favouriteColours.toStream().to("car-colour-output", Produced.with(Serdes.String(),Serdes.Long()));
